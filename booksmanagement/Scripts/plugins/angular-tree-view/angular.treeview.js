		...
		return {
			...
			link: function ( scope, element, attrs ) {
				...
				var template_book =
					...
					'<a title="Download book" href="#" data-ng-show="(node.car || node.carPart || node.carPartComp ||node.carPartCompDesc) && node.softCopy" style="padding-left:5px;"><i class="fa fa-download"></i></a>' +
					'<a title="Part code paper" href="#" data-ng-show="(node.car || node.carPart || node.carPartComp ||node.carPartCompDesc) && (node.softCopy || node.bookAvailable)" style="padding-left:5px;"><i class="fa fa-file-text-o"></i></a>' +
