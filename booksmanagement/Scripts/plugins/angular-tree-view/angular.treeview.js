		...
		return {
			...
			link: function ( scope, element, attrs ) {
				...
				var template_book =
					...
					'<a title="Download book" href="' + root +'api/Books/GetSoftFile/{{node.bookId}}" data-ng-show="(node.car || node.carPart || node.carPartComp ||node.carPartCompDesc) && node.softCopy" style="padding-left:5px;" download="" target="_blank"><i class="fa fa-download"></i></a>' +
					'<a title="Part code paper" href="' + root +'api/Books/GetPartCodeFile/{{node.bookId}}" data-ng-show="(node.car || node.carPart || node.carPartComp ||node.carPartCompDesc) && (node.softCopy || node.bookAvailable)" style="padding-left:5px;" download="" target="_blank"><i class="fa fa-file-text-o"></i></a>' +
